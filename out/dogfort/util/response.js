...
dogfort.util.response.response = (function dogfort$util$response$response(){
var args__1276__auto__ = [];
var len__1269__auto___2222 = arguments.length;
var i__1270__auto___2223 = (0);
while(true){
if((i__1270__auto___2223 < len__1269__auto___2222)){
args__1276__auto__.push((arguments[i__1270__auto___2223]));

var G__2224 = (i__1270__auto___2223 + (1));
i__1270__auto___2223 = G__2224;
continue;
} else {
}
break;
...
return dogfort.util.response.response.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__1277__auto__);
});

dogfort.util.response.response.cljs$core$IFn$_invoke$arity$variadic = (function (status,body,p__2220){
var vec__2221 = p__2220;
var content_type = cljs.core.nth.call(null,vec__2221,(0),null);
...
dogfort.util.response.response.cljs$lang$applyTo = (function (seq2217){
var G__2218 = cljs.core.first.call(null,seq2217);
var seq2217__$1 = cljs.core.next.call(null,seq2217);
var G__2219 = cljs.core.first.call(null,seq2217__$1);
var seq2217__$2 = cljs.core.next.call(null,seq2217__$1);
return dogfort.util.response.response.cljs$core$IFn$_invoke$arity$variadic(G__2218,G__2219,seq2217__$2);
});
